...
define(['utils'],function (utils) {
    ...
    deliveryState.put("4","已完成");
    /**
     * 设备状态
     */
    var deviceState = utils.Map();
    deviceState.put("1","启用");
    deviceState.put("2","停用");
    /**
     * 设备型号
     */
    var deviceModel = utils.Map();
    deviceModel.put("1","AZ-V132L");
    deviceModel.put("2","AZ-V105L");
    /**
     * 设备类型
     */
    var deviceType = utils.Map();
    deviceType.put("grid","格子柜(AZMCU-01)")
    deviceType.put("agrid","格子柜(AZMCU-02)")
    deviceType.put("box","综合机")
    deviceType.put("star","智能货柜")
    deviceType.put("shelf","无人货架")
    /**
     * 设备通讯类型
     */
    var deviceTelecomType = utils.Map();
    deviceTelecomType.put("1","wifi")
    deviceTelecomType.put("2","流量卡")
    /**
     * 柜台类型
     */
    var counterType = utils.Map();
    counterType.put("grid","魔格grid");
    counterType.put("net","线上商城");
    counterType.put("cash","现金交易");
    /**
     * 销售记录-出货类型
     */
     ...
     * 销售记录-前台送货-出货状态
     */
    var deliveryStatus = utils.Map();
    deliveryStatus.put('1','待配送');
    deliveryStatus.put('2','待配送');
    deliveryStatus.put('3','配送中');
    deliveryStatus.put('4','已配送');
    /**
     * 销售记录-支付状态
     */
    ...
    return {
        ...
        deviceTelecomType:deviceTelecomType,
